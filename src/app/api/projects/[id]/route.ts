...
export async function GET(request: NextRequest, { params }: slugParams) {
    try {
        ...
        if (querySnapshot.exists()) {
            ...
            return Response.json({ message: 'No such project!', status: "FAILURE"})
        }
...
export async function PATCH(request: NextRequest, { params }: slugParams) {
    try {
        ...
        return Response.json({ message: 'successfully updated the project', status: "SUCCESS" })
    } catch (error: any) {
        return Response.json({
            status: 'FAILURE',
            message: (error as Error).message
...
export async function DELETE(request: NextRequest, { params }: slugParams) {
    try {
        ...
        return Response.json({ message: 'successfully deleted a project', status: "SUCCESS" })
    } catch (error: any) {
        return Response.json({
            status: 'FAILURE',
            message: (error as Error).message
