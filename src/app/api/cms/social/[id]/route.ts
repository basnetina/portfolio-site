...
export async function GET(request: NextRequest, { params }: slugParams) {
    try {
        ...
        if (querySnapshot.exists()) {
            ...
            return Response.json({ message: 'No such social links!', status: "FAILURE"})
        }
...
export async function PATCH(request: NextRequest, { params }: slugParams) {
    try {
        ...
        return Response.json({ message: 'successfully updated the social content', status: "SUCCESS" })
    } catch (error: any) {
        return Response.json({
            status: 'FAILURE',
            message: (error as Error).message
...
export async function DELETE(request: NextRequest, { params }: slugParams) {
    try {
        ...
        return Response.json({ message: 'successfully deleted a social content', status: "SUCCESS" })
    } catch (error: any) {
        return Response.json({
            status: 'FAILURE',
            message: (error as Error).message
